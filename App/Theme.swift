...
enum Theme {
    ...
    // separation (U9).
    //
    // Beet mode swaps the whole neutral ramp for one derived from Beet Red
    // (Pantone 19-2030 TCX): same lightness steps as dark, plum-tinted hue.
    static let bg           = Color.dynamic(light: 0xF6F7F9, dark: 0x0C0E14, beet: 0x150A10)
    static let surface      = Color.dynamic(light: 0xFFFFFF, dark: 0x181C26, beet: 0x22121B)
    static let surfaceInset = Color.dynamic(light: 0xE3E6EB, dark: 0x232837, beet: 0x2F1A25)
    static let hairline     = Color.dynamic(light: 0xE1E4EA, dark: 0x343B4E, beet: 0x492838)
    ...
    // beet tiers keep the same contrast on the plum ramp (warm-tinted so
    // they never clash with the hue).
    static let textPrimary   = Color.dynamic(light: 0x14161A, dark: 0xF2F4F8, beet: 0xFAF2F5)
    static let textSecondary = Color.dynamic(light: 0x5B616E, dark: 0xA3AABB, beet: 0xC7AAB6)
    static let textTertiary  = Color.dynamic(light: 0x8A909C, dark: 0x717889, beet: 0x93727F)
